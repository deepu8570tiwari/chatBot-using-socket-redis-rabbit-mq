...
interface chatSideBarProps {
  ...
  setSelectdUser: (userId: string | null) => void;
  handleLogout: () => void;
...
const ChatSideBar = ({
            ...
            <div className="space-y-2 overflow-y-auto h-full pb-4">
              {users
                ...
                .map((u) => (
                  <button
                    key={u._id}
                    className="textuser w-full text-left p-4 rounded-lg border border-gray-700 hover:border-gray-600
  ...
  const isSentByMe = latestMessage?.sender === loggedInUserId;
    ...
    >
      ...
      <div className="p-4 border-t border-gray-700 space-y-2">
        ...
        <button
          ...
          className="w-full flex items-center gap-2 px-3 py-3 rounded-lg hover:bg-red-600 transition-colors text-red-500 hover:text-white"
        >
